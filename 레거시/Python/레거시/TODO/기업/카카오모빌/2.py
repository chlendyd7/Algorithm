def solution(cap, n, deliveries, pickups):
    ...
    print(delivery_stack, pickup_stack)
    ...
    def calculate_max_distance(stack):
        ...
        while stack:
            ...
            if total_boxes + boxes > cap:
                ...
                stack.append([house, remaining_boxes])  # Push back the remaining boxes
                return max_distance
    ...
    while delivery_stack or pickup_stack:
        ...
        max_pickup_distance = calculate_max_distance(pickup_stack)
        total_distance += max(max_delivery_distance, max_pickup_distance) * 2  # Round trip
